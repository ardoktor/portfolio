...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-vq+)5s!^gzipz!erz5(#sc=kw2w$ng#&l-(+!eg^c927w%t8i0')

# DEBUG: False in production (set DEBUG=True in Render env vars to enable)
